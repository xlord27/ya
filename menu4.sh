...
export sem=$( curl -s https://raw.githubusercontent.com/xlord27/test/main/versions)
...
21) clear ; clearlog ;;
#99) clear ; update ;;
22) clear ; wget https://raw.githubusercontent.com/xlord27/ya/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
