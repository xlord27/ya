...
LLatest=`date`
Get_Data () {
git clone https://github.com/xlord27/userbackup.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git config --global user.name "xlord27" &> /dev/null
    rm -fr .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m m &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/xlord27/userbackup
    git push -f https://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@github.com/xlord27/userbackup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/xlord27/userbackup/main/$NameUser/$NameUser.zip"
sleep 1
...
cekdata=$(curl -sS https://raw.githubusercontent.com/xlord27/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
mkdir /root/backup
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/xlord27/userbackup/main/$NameUser/$NameUser.zip" &> /dev/null
